...
const DEFAULT_TEMPLATES: Omit<AnalysisTemplate, "id" | "createdAt">[] = [
  ...
  },
  {
    ...
    gensparkTone: "friendly",
    gensparkNotes: "",
    memo: "施術説明PDFをアップしてInstagram投稿文を一気に生成",
  },
  {
    name: "採用面接質問集用",
    analysisType: "interview_questions",
    analysisPurpose: "",
    gensparkTarget: "management",
    gensparkLevel: "detailed",
    gensparkPurpose: "educate",
    gensparkTone: "professional",
    gensparkNotes: "",
    memo: "求人要件をテキスト入力して選択理論ベースの面接質問集を生成",
  },
  {
    name: "口コミ返信文用",
    analysisType: "review_reply",
    analysisPurpose: "",
    gensparkTarget: "all_staff",
    gensparkLevel: "standard",
    gensparkPurpose: "inform",
    gensparkTone: "professional",
    gensparkNotes: "",
    memo: "Googleマップ等の口コミをテキスト入力して返信文を生成",
  },
];
