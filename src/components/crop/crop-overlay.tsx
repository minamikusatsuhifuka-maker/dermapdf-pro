      ...
      <div className="flex flex-col items-center gap-4 p-4">
        ...
        >
          ...
          {rect && rect.width > 2 && rect.height > 2 && (
            <div
              className="absolute border-2 border-dashed border-[#378ADD] bg-[#378ADD]/10"
              style={{
                left: rect.x,
                top: rect.y,
                width: rect.width,
        ...
        <div className="flex gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[#378ADD] hover:bg-[#185FA5] px-6 py-2.5 text-sm font-medium text-white shadow-lg transition-opacity disabled:opacity-40"
          >
          ...
          {onCropAndRemoveBg && (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#1D9E75] hover:bg-[#0F6E56] px-6 py-2.5 text-sm font-medium text-white shadow-lg transition-opacity disabled:opacity-40"
            >
